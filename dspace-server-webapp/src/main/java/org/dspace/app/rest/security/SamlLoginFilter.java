 ...
 *      See {@link org.dspace.authenticate.SamlAuthentication} loginPageURL() method.
 ...
 *      SamlAuthentication.authenticate()) and stores that user info in a JWT. It also saves that JWT in a *temporary*
 ...
 * @author Tim Donohue
 * @see org.dspace.authenticate.SamlAuthentication
 */
public class SamlLoginFilter extends StatelessLoginFilter {
    ...
    public SamlLoginFilter(String url, AuthenticationManager authenticationManager,
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        // SamlAuthentication.authenticate() to check for a valid Shibboleth login, and if found, the current user
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        log.debug("Saml authentication successful for EPerson {}. Sending back temporary auth cookie",
